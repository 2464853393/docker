...
#启动nginx服务
/usr/local/nginx/sbin/nginx -c /home/sql/conf/nginx.conf &
...
if [ ! -f /usr/bin/mysql-datatools.txt ]; then
  ...
  mysql -uroot -p123456 < /home/sql/datagov-0319.sql --default-character-set=utf8  

fi
echo "mysql inited"


#生成license  输入时间戳  再Dockerfile中生成license
#cd /home/sql && java -cp ls-0.0.1-SNAPSHOT.jar  com.yeexun.ls.LicenseGenerator start 1556640000000
