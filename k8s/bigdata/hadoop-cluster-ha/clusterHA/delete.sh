...
kubectl create -f ./datanode/datanode-statefulSet.yaml
...
#kubeclk create -f ./nfs-pv-pvc/hadoop/datanode-pv-pvc-0.yaml
#kubeclk create -f ./nfs-pv-pvc/hadoop/datanode-pv-pvc-1.yaml
#kubeclk create -f ./nfs-pv-pvc/hadoop/datanode-pv-pvc-2.yaml
#kubeclk create -f ./nfs-pv-pvc/hadoop/journalnode-pv-pvc-0.yaml
#kubeclk create -f ./nfs-pv-pvc/hadoop/journalnode-pv-pvc-1.yaml
#kubeclk create -f ./nfs-pv-pvc/hadoop/journalnode-pv-pvc-2.yaml
#kubeclk create -f ./nfs-pv-pvc/hadoop/namenode-master-pv-pvc.yaml
#kubeclk create -f ./nfs-pv-pvc/hadoop/namenode-standby-pv-pvc.yaml
